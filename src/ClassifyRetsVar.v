...
- if ident of the variable is in return parameters, return a Ssvar sexp
- otherwise, return a Svar sexp. 
*)
...
Definition trans_body(b: func): func :=
  ...
  (mknode b.(nd_kind) (nd_args b) (nd_rets b) (nd_flags b) (nd_svars b) (nd_vars b)
...
Definition trans_program (p: LustreF.program): program :=
  ...
  (mkprogram (type_block p) (const_block p) nodes1 (node_main p)).
