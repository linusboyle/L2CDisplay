...
Definition classify_cast (tfrom tto: type) : classify_cast_cases :=
  ...
  | Tint I32 si2 , (Tint _ _ | Tpointer _ | Tarray _ _ _ | Tfunction _ _) => cast_case_neutral
  | Tint IBool _, Tfloat F64 => cast_case_f2bool
  | Tint IBool _, Tfloat F32 => cast_case_s2bool
  | Tint IBool _, (Tpointer _ | Tarray _ _ _ | Tfunction _ _) => cast_case_p2bool
  ...
  | Tpointer _ , (Tint _ _ | Tpointer _ | Tarray _ _ _ | Tfunction _ _) => cast_case_neutral
...
Proof.
  ...
  assert (A: classify_bool t =
    match t with
    | Tint _ _ => bool_case_i
    | Tpointer _ | Tarray _ _ _ | Tfunction _ _ => bool_case_p
    | Tfloat F64 => bool_case_f
    | Tfloat F32 => bool_case_s
    | _ => bool_default
    end).
